...
Les CSV apparaissent dans `tools/whisper/examples/shared/producer/out_1.csv` et `tools/whisper/examples/shared/consumer/out_1.csv` (dossier ignoré par git, régénéré à chaque run).
